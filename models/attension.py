...
if __name__ == '__main__':
    # 创建：self.AdainResBlk2 = SpatialTransformer(style_dim=512)，调用：s = self.AdainResBlk2(s,ref1)，s是B * 512 * H * W，ref1是B * n * 512
    a=torch.rand(2,512,64,64)
    ref=torch.rand(2,10,512)
    attension=SpatialTransformer(in_channels=512)
    output=attension(a,ref)
    print(output.shape)